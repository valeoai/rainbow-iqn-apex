...
then
    ...
    gnome-terminal -e "python rainbowiqn/launch_learner.py --nb-actor $nb_actors --game $game --gpu-number ${tab_gpu_number[0]}"
    ...
    do
        gnome-terminal -e "python rainbowiqn/launch_actor.py --nb-actor $nb_actors --id-actor $(($index_actor - 1)) --game $game --gpu-number ${tab_gpu_number[$index_actor]}"
