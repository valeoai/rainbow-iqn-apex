...
hack_set_full_capacity_to_true = 200000 # This is just a hack, really not important to understand (the computational gain is probably insignificant)
# Number of steps between HACK of set memory_full to true,
# the redis memory is passed by copy in another thread and thus his memory_full parameter is never updated
